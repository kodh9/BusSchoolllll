...
<body>
    <div class="dark">
        <div class="b"></div>
        <a href="http://localhost/bus%20school/createAR1/createAR.php"><img src="arabic.png"></a>
        <a href="http://localhost/bus%20school/create%20page/create%20bc.php"><ion-icon name="moon-sharp"></ion-icon></a>
    </div>
    <div class="cre">
        <img src="imayges.png">
        <h1>WELCOME</h1>
        <form action="create_post.php" method="post">
            <p><input type="text" name="username" placeholder="Full Name">
                <input type="email" name="email" placeholder="Email"></p>
                <p><input type="number" name="phone" placeholder="Phone Number">
                <input type="text"  name="Street" placeholder="Street"></p> 
                <p><input type="text" name="Neighborhood" placeholder="Neighborhood">
                <input type="text" name="Postal" placeholder="Postal Code"></p>
                <p><input type="password" name="Password" placeholder="Password">
                <input type="password" placeholder="Repeat Password"></p>
