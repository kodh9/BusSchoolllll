...
<head>
    ...
    <link rel="stylesheet" href="createAR.css">
...
<body>
    <div class="dark">
        <div class="b"></div>
        <a href="http://localhost/bus%20school/create%20page1/createBC.php"><img src="arabic.png"></a>
        <a href="http://localhost/bus%20school/create%20ar/cr%20ar.php"><ion-icon name="moon-sharp"></ion-icon></a>
    </div>
    <div class="cre">
        <img src="imayges.png">
        <h1>اهلا بك</h1>
