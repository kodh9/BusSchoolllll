...
<body>
    <div class="dark">
        <div class="b"></div>
        <a href="http://localhost/bus%20school/Evaluation/Evaluation%20ar%20dm.php"><img src="arabic.png"></a>
        <a href="http://localhost/bus%20school/Evaluation/Evaluation.php"><ion-icon name="moon-sharp"></ion-icon></a>
    </div>
    <div class="container">
